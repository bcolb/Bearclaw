...
''' WildThumper.py: Creates an API for the Wild Thumper Controller\n
    board based off of the Arduino 128P. Options include reading\n
...
if __name__=='__main__':
    ...
    # object for serial communications to occur correctly
